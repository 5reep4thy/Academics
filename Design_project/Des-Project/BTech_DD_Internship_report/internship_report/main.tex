...
%======================================================================|
\thesistitle{A Fun Virtual Cam \\ Design project Report}
\authors{Student Sreepathy Jayanand. \\[-2mm] (Roll No: CED17I038)}
...
\vspace{1.5cm} % Horizontal line
 ...
 \large \textit{Design project report submitted in partial fulfilment of the requirements\\ for the degree of B.Tech. and M.Tech}\\[0.3cm] % University requirement text
\textit{by}\\[0.4cm]
...
%\end{center}
\noindent I, \textbf{Sreepathy Jayanand}, with Roll No: \textbf{CED17I038} hereby declare that the material presented in the Design Project Report titled \textbf{A Fun Virtual Cam} \noindent represents original work carried out by me in the \textbf{Department of Computer Science and Engineering} at the \textbf{Indian Institute of Information Technology, 
...
\noindent {\footnotesize{Date: December 11 2021	\hfill	Student's Signature: Sreepathy Jayanand}} \qquad
...
\noindent  {\footnotesize{Advisor's Name: Dr. B Sivaselvan \hfill Advisor's Signature: B Sivaselvan }} \qquad
