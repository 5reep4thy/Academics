...
%======================================================================|
\thesistitle{An approach for commonsense inference using Macaw encoder}
...
\vspace{1.5cm} % Horizontal line
 ...
 \large \textit{Mid-semester project report submitted in partial fulfilment of the requirements\\ for the degree of B.Tech. and M.Tech}\\[0.3cm] % University requirement text
\textit{by}\\[0.4cm]
...
%\end{center}
\noindent I, \textbf{Sreepathy Jayanand}, with Roll No: \textbf{CED17I038} hereby declare that the material presented in the Project Report titled \textbf{An approach for commonsense inference using Macaw encoder} \noindent represents original work carried out by me in the \textbf{Department of Computer Science and Engineering} at the \textbf{Indian Institute of Information Technology, 
...
\noindent {\footnotesize{Date: March 6 2022	\hfill	Student's Signature: Sreepathy Jayanand}} \qquad
...
that the work presented in this report is carried out under my supervision, and is worthy of consideration for the requirements of mid-semester project during the period Jan 2022 to Feb 2022.
\vspace{10mm}

\noindent  {\footnotesize{Advisor's Name: Dr. B Sivaselvan \hfill Advisor's Signature:Dr. B Sivaselvan }} \qquad
...
This report documents the literature survey on the different approaches in natural language processing for predicting subsequent sentences given context. It also contains a novel approach on using an encoder of a generative model for non-autoregressive tasks.
}
